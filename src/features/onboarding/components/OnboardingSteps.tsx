  ...
  return (
    <div className="space-y-6">
      <div className="text-center mb-8">
        <div className="inline-flex items-center justify-center w-20 h-20 bg-linear-to-br from-[#0D7377] to-[#4A7C59] rounded-2xl mb-4">
          <Sparkles className="w-10 h-10 text-white" />
        </div>
        <h3 className="text-2xl font-bold text-[#2D3436] mb-2">
          Welcome to PassAI! 🎉
        </h3>
        <p className="text-[#2D3436]/70 max-w-lg mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="p-4 bg-[#0D7377]/5 rounded-xl border border-[#0D7377]/20">
          <div className="w-10 h-10 bg-[#0D7377] rounded-lg flex items-center justify-center mb-3">
            <BookOpen className="w-5 h-5 text-white" />
          </div>
          <h4 className="font-bold text-[#2D3436] mb-1">Add Subjects</h4>
        ...
        <div className="p-4 bg-[#0D7377]/5 rounded-xl border border-[#0D7377]/20">
          ...
          <h4 className="font-bold text-[#2D3436] mb-1">Upload Materials</h4>
          <p className="text-sm text-[#2D3436]/70">
            Upload your study notes, PDFs, or textbooks
          </p>
        </div>

        <div className="p-4 bg-[#6A994E]/5 rounded-xl border border-[#6A994E]/20">
          <div className="w-10 h-10 bg-[#4A7C59] rounded-lg flex items-center justify-center mb-3">
        ...
        <div className="p-4 bg-amber-50 rounded-xl border border-amber-200">
          ...
          <h4 className="font-bold text-[#2D3436] mb-1">Track Progress</h4>
          <p className="text-sm text-[#2D3436]/70">
      ...
      <div className="bg-linear-to-br from-[#FAF3E0] to-[#0D7377]/5 rounded-xl p-6 border border-[#E8E4E1]">
        <p className="text-sm text-[#2D3436]/80 text-center">
...
export const SubjectsStep: React.FC = () => {
  return (
    <div className="space-y-6">
      <div className="flex items-start gap-4 p-4 bg-[#0D7377]/5 rounded-xl border-2 border-[#0D7377]/20">
        <div className="w-10 h-10 bg-[#0D7377] rounded-lg flex items-center justify-center shrink-0">
          <BookOpen className="w-5 h-5 text-white" />
        </div>
        <div>
          <h3 className="font-bold text-[#2D3436] mb-1">Add Your Subjects</h3>
          <p className="text-sm text-[#2D3436]/70">
      ...
      <div className="space-y-4">
        <div className="flex items-start gap-3">
          <div className="w-6 h-6 bg-[#0D7377] rounded-full flex items-center justify-center shrink-0 mt-0.5">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            <h4 className="font-semibold text-[#2D3436] mb-1">Set Your Goal</h4>
            <p className="text-sm text-[#2D3436]/70">
      ...
      <div className="bg-linear-to-br from-amber-50 to-orange-50 rounded-xl p-4 border border-amber-200">
        <p className="text-sm text-[#2D3436]/80">
...
export const MaterialsStep: React.FC = () => {
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <div className="p-4 bg-white rounded-xl border-2 border-dashed border-[#E8E4E1]">
          <div className="flex items-center gap-3 mb-2">
            <div className="w-8 h-8 bg-[#FAF3E0] rounded-lg flex items-center justify-center">
              <span className="text-sm font-bold text-[#2D3436]/70">PDF</span>
            </div>
            <div className="flex-1">
              <p className="font-semibold text-[#2D3436] text-sm">
                Supported Formats
              </p>
              <p className="text-xs text-[#2D3436]/70">PDF, DOCX, TXT, and more</p>
            </div>
          </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            <h4 className="font-semibold text-[#2D3436] mb-1">AI Analysis</h4>
            <p className="text-sm text-[#2D3436]/70">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            <h4 className="font-semibold text-[#2D3436] mb-1">Smart Quizzes</h4>
            <p className="text-sm text-[#2D3436]/70">
      ...
      <div className="bg-linear-to-br from-[#0D7377]/5 to-[#4A7C59]/5 rounded-xl p-4 border border-[#0D7377]/20">
        <p className="text-sm text-[#2D3436]/80">
...
export const QuizzesStep: React.FC = () => {
  return (
    <div className="space-y-6">
      <div className="flex items-start gap-4 p-4 bg-[#6A994E]/5 rounded-xl border-2 border-[#6A994E]/20">
        <div className="w-10 h-10 bg-[#4A7C59] rounded-lg flex items-center justify-center shrink-0">
          <Brain className="w-5 h-5 text-white" />
        </div>
        <div>
          <h3 className="font-bold text-[#2D3436] mb-1">Take AI Quizzes</h3>
          <p className="text-sm text-[#2D3436]/70">
      ...
      <div className="space-y-4">
        <div className="p-4 bg-white rounded-xl border-2 border-[#E8E4E1]">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-[#2D3436]/70">Quick knowledge checks</p>
              </div>
            </div>
            <span className="text-xs font-medium text-[#0D7377] bg-[#0D7377]/5 px-2 py-1 rounded">
              AI Graded
            </span>
          </div>
        </div>
          ...
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-[#2D3436]/70">Test understanding</p>
              </div>
            </div>
            <span className="text-xs font-medium text-[#0D7377] bg-[#0D7377]/5 px-2 py-1 rounded">
              AI Graded
        ...
        <div className="p-4 bg-white rounded-xl border-2 border-[#E8E4E1]">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="font-semibold text-[#2D3436] text-sm">Essay</p>
                <p className="text-xs text-[#2D3436]/70">Deep analysis</p>
              </div>
            </div>
            <span className="text-xs font-medium text-[#4A7C59] bg-[#6A994E]/5 px-2 py-1 rounded">
              AI Graded
            </span>
          </div>
        </div>
      ...
      <div className="bg-linear-to-br from-[#6A994E]/5 to-[#6A994E]/5 rounded-xl p-4 border border-[#6A994E]/20">
        <p className="text-sm text-[#2D3436]/80">
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-start gap-4 p-4 bg-amber-50 rounded-xl border-2 border-amber-200">
        ...
        <div>
          <h3 className="font-bold text-[#2D3436] mb-1">Track Your Progress</h3>
          <p className="text-sm text-[#2D3436]/70">
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            <h4 className="font-semibold text-[#2D3436] mb-1">Garden Health</h4>
            <p className="text-sm text-[#2D3436]/70">
      ...
      <div className="bg-linear-to-br from-[#0D7377] to-[#4A7C59] rounded-xl p-6 text-white text-center">
        <div className="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center mx-auto mb-3">
          <Sparkles className="w-6 h-6 text-white" />
        </div>
        <h4 className="font-bold mb-2">You're All Set!</h4>
        <p className="text-sm text-[#0D7377]/10">
